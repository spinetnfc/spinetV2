      ...
      <div className="container z-10 text-center p-0">
        ...
        <div className="flex flex-col items-center gap-2 ">
          <div className="flex flex-row items-center justify-center gap-2">
            <h1 className="text-3xl xs:text-4xl sm:text-5xl tracking-tighter text-spinet-deep lg:text-6xl xl:text-8xl  sm:pb-2">
          ...
          <div className="flex items-center gap-2">
            <h2 className="text-3xl xs:text-4xl sm:text-5xl tracking-tighter text-spinet-deep lg:text-6xl xl:text-8xl ">
