...
function EmpowerNetwork({ locale, isMenuOpen, setIsMenuOpen }: Props) {
  ...
  // Early return with a simple skeleton/placeholder while mounting
  if (!mounted) {
    return (
      ...
      <div className=" flex size-full">
        <div className="pointer-events-none absolute inset-0">
          ...
          <img
            src={
              resolvedTheme === 'dark'
                ? '/img/Ellipse-three-dark.png'
                : '/img/Ellipse-three.png'
            }
            alt=""
        ...
        <div className="container  z-10 mx-auto px-4 lg:px-0">
          {/* Title Container */}
          <div className="mt-20 flex flex-col items-center space-y-2 text-center">
