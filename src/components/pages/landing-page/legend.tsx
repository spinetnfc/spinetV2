  ...
  return (
    <>
      <div className="hidden h-8 lg:block">
        <span
          className={cn(
            'h-5 rounded-full  border border-[#145FF2]/10 bg-white/[0.15] bg-linear-to-r from-[#145FF2] to-[#BDDDFF] bg-clip-text px-3 py-1.5 text-center text-sm font-normal uppercase  tracking-[3px] text-transparent shadow-[0_4px_4px_rgba(20,95,242,0.05)] dark:border-white/[0.15] dark:bg-white/[0.05] dark:from-[#EEF6FF] dark:to-[#145FF2]',
