...
import { useRegisterViewModel } from '@/lib/viewmodels/auth/register.viewmodel';
      ...
      <div className="space-y-6">
         ...
         <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
               {t('auth.register.login').split('?')[0]}?{' '}
               <Link
                  href={`/${locale}/auth/login`}
                  className="text-primary hover:text-primary/80 font-medium transition-colors"
               >
                  {t('auth.register.login').split('?')[1]?.trim() || 'Sign in'}
               </Link>
            </p>
         </div>
         ...
         <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
               <Label htmlFor="confirmPassword" className="text-foreground">{t('auth.register.confirm-password')}</Label>
               <div className="relative">
                  <Input
                     id="confirmPassword"
            ...
            >
               {isLoading ? (
                  <div className="flex items-center gap-2">
                     ...
                     {t('auth.register.creating-account')}
                  </div>
               ) : (
         ...
         <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
               <span className="bg-card px-2 text-muted-foreground">
                  {t('auth.register.or-continue-with')}
               </span>
            </div>
         </div>
         ...
         <div className="space-y-3">
            ...
            <Button
               variant="outline"
               className="w-full border-border hover:bg-muted transition-colors"
               onClick={() => console.log('Apple register clicked')}
               disabled={isLoading}
            >
            ...
            <Button
               variant="outline"
               className="w-full border-border hover:bg-muted transition-colors"
               onClick={() => console.log('SSO register clicked')}
               disabled={isLoading}
            >
               {t('auth.register.sso')}
            </Button>
