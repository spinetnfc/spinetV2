...
interface ContactsHeaderProps {
  ...
  onContactSourceClick: () => void
}

const undo = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 7V13H9" stroke="#111827" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M21 17C21 14.6131 20.0518 12.3239 18.364 10.636C16.6761 8.94821 14.3869 8 12 8C9.78512 8.00226 7.64885 8.82116 6 10.3L3 13" stroke="#111827" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  )
}


export function ContactsHeader({ contactsCount, onAdvancedFiltersClick, onContactSourceClick }: ContactsHeaderProps) {
  return (
    <div className="mb-6">
      ...
      <div className="flex justify-between items-center gap-4 mb-4">
       <div className="flex items-center gap-2">
        ...
        <Button variant="outline" size="sm" onClick={onContactSourceClick} className="border-none hover:bg-blue-100">
          Contact source <ChevronDown size={18} />
        </Button>
